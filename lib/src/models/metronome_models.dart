...
enum BeatRhythmType {
  ...
  eighthTwoSixteenth('eighth_two_sixteenth', '前八后十六', '8+16', 4, [
    0,
    2,
    3,
  ], 'assets/images/subdivision-7.webp'),
  twoSixteenthEighth('two_sixteenth_eighth', '前十六后八', '16+8', 4, [
    0,
    1,
    2,
  ...
  static BeatRhythmType fromToken(String token) {
    final alias = switch (token) {
      ...
      'eighth_rest' => 'eighth_triplet',
      'rest_eighth' => 'eighth_triplet',
      'triplet_rest_first' => 'dotted_eighth_sixteenth',
      'triplet_rest_middle' => 'sixteenth_dotted_eighth',
      'triplet_rest_last' => 'eighth_two_sixteenth',
      _ => token,
    };
    for (final type in values) {
      if (type.token == alias) {
